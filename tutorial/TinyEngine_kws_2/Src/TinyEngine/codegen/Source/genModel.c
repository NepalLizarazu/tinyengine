...
/* layer 0:CONV_2D */
convolve_s8_kernel3_inputch3_stride2_pad1_fpreq(&buffer0[8000],10,49,1,(const q7_t*) weight0,bias0,scales0,0,0,-128,127,&buffer0[0],5,25,64,sbuf,kbuf,0);
/* layer 1:DEPTHWISE_CONV_2D */
depthwise_kernel3x3_stride1_inplace_CHW_fpreq(&buffer0[0],5,25,64,(const q7_t*) CHWweight1,offsetBias1,offsetRBias1,scales1,0,0,-128,127,&buffer0[0],5,25,64,sbuf,0);
/* layer 2:CONV_2D */
convolve_1x1_s8_fpreq(&buffer0[0],5,25,64,(const q7_t*) weight2,bias2,scales2,0,0,-128,127,&buffer0[8000],5,25,64,sbuf);
/* layer 3:DEPTHWISE_CONV_2D */
depthwise_kernel3x3_stride1_inplace_CHW_fpreq(&buffer0[8000],5,25,64,(const q7_t*) CHWweight3,offsetBias3,offsetRBias3,scales3,0,0,-128,127,&buffer0[8000],5,25,64,sbuf,0);
/* layer 4:CONV_2D */
convolve_1x1_s8_fpreq(&buffer0[8000],5,25,64,(const q7_t*) weight4,bias4,scales4,0,0,-128,127,&buffer0[0],5,25,64,sbuf);
/* layer 5:DEPTHWISE_CONV_2D */
depthwise_kernel3x3_stride1_inplace_CHW_fpreq(&buffer0[0],5,25,64,(const q7_t*) CHWweight5,offsetBias5,offsetRBias5,scales5,0,0,-128,127,&buffer0[0],5,25,64,sbuf,0);
/* layer 6:CONV_2D */
convolve_1x1_s8_fpreq(&buffer0[0],5,25,64,(const q7_t*) weight6,bias6,scales6,0,0,-128,127,&buffer0[8000],5,25,64,sbuf);
/* layer 7:DEPTHWISE_CONV_2D */
depthwise_kernel3x3_stride1_inplace_CHW_fpreq(&buffer0[8000],5,25,64,(const q7_t*) CHWweight7,offsetBias7,offsetRBias7,scales7,0,0,-128,127,&buffer0[8000],5,25,64,sbuf,0);
/* layer 8:CONV_2D */
convolve_1x1_s8_fpreq(&buffer0[8000],5,25,64,(const q7_t*) weight8,bias8,scales8,0,0,-128,127,&buffer0[16000],5,25,64,sbuf);
...
const float v5_bias_QAS[10] = {4377485000.0,4262056700.0,4229562000.0,4342876000.0,4236861700.0,4309572600.0,4228692700.0,4201255200.0,4401403400.0,4170322200.0,};
fptr = (float*)&buffer0[108];//gradients
for(int i = 0; i < 10; i++) v5_bias[i] -= (int32_t)(fptr[i] * blr * v5_bias_QAS[i]);
/* layer 24:GROUP_CONV */
const float v5_weight_QAS[10] = {1085618.4,1056992.2,1048933.5,1077035.4,1050743.9,1068776.1,1048717.9,1041913.5,1091550.1,1034241.94,};
